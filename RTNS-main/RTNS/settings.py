...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER':'postgres',
        'PASSWORD':'tVbnzjrmLktxrhAvejdAkGrQcDsBQCIV',
...
CSRF_TRUSTED_ORIGINS=['https://web-production-eba5.up.railway.app','https://rtns-uejbd.org','https://web-production-83bf.up.railway.app']